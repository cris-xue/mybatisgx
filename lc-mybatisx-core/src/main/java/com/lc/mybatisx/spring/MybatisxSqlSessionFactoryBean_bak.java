 ...
 */
public class MybatisxSqlSessionFactoryBean_bak implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
    ...
    /**
     * Set the location of the MyBatis {@code SqlSessionFactory} mapper file. A typical value is
     * "WEB-INF/mybatis-configuration.xml".
     *
     * @param configLocation a location the MyBatis mapper file
     */
     ...
     * <p>
     * This is an alternative to specifying "&lt;sqlmapper&gt;" entries in an MyBatis mapper file.
     ...
     * resolve placeholders in the mapper file.
     *
     ...
     * mapper file. This is used only as a placeholder name. The default value is
     ...
     * Since 1.3.0, it can be specified a {@link Configuration} instance directly(without mapper file).
     *
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws Exception {
        ...
        if (xmlConfigBuilder != null) {
            try {
                ...
                throw new NestedIOException("Failed to parse mapper resource: " + this.configLocation, ex);
            } finally {
    ...
    /*private void curdMethod() {
        MybatisxXMLMapperBuilder xmlMapperBuilder = new MybatisxXMLMapperBuilder(mapperLocation.getInputStream(),
                targetConfiguration, mapperLocation.toString(), targetConfiguration.getSqlFragments());
        xmlMapperBuilder.parse();
    }*/
