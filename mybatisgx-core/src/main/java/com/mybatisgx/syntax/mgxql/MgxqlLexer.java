...
public class MgxqlLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"SELECT_COUNT", "SELECT_MAX", "SELECT_MIN", "SELECT_AVG", "FROM", "LEFT", 
			"JOIN", "WHERE", "LOGIC_AND", "LOGIC_OR", "COMPARISON_OP_LT", "COMPARISON_OP_LT_EQ", 
			...
			"LIMIT_IDENTIFIER", "LEFT_BRACKET", "RIGHT_BRACKET", "COMMA", "COLON", 
			"DOT", "UPPER_NAME", "LOWER_NAME", "UPPER", "LOWER", "NUMBER", "WS"
		};
	}
