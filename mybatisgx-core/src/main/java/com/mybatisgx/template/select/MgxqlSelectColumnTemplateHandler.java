...
public class MgxqlSelectColumnTemplateHandler {
    ...
    private static class AliasContext {
        ...
        private AliasContext(Map<String, ColumnEntityRelation> aliasMap, String mainTableName,
                             String mainTableAlias, ColumnEntityRelation rootRelation) {
        ...
        static AliasContext build(SelectStatement selectStatement, ColumnEntityRelation rootRelation) {
            ...
            if (rootRelation != null) {
                ...
                mainTableName = (primaryEntity != null && primaryEntity.getEntityInfo() != null)
