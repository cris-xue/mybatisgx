 ...
 * @date 2025/9/6 14:05
 */
public class SelectCountSqlTemplateHandler {

    private static final Logger logger = LoggerFactory.getLogger(SelectCountSqlTemplateHandler.class);
    ...
    private PlainSelect buildMainSelect() {
        ...
        countFunction.setParameters(new ExpressionList(Arrays.asList(new AllColumns())));
