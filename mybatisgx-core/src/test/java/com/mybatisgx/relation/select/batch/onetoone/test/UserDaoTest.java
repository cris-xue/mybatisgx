package com.mybatisgx.relation.select.batch.onetoone.test;

import com.github.swierkosz.fixture.generator.FixtureGenerator;
import com.mybatisgx.entity.MultiId;
import com.mybatisgx.relation.select.batch.onetoone.dao.UserDao;
import com.mybatisgx.relation.select.batch.onetoone.dao.UserDetailDao;
