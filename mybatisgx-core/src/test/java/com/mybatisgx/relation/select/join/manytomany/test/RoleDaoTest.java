package com.mybatisgx.relation.select.join.manytomany.test;

import com.github.swierkosz.fixture.generator.FixtureGenerator;
import com.mybatisgx.relation.select.join.manytomany.dao.RoleDao;
import com.mybatisgx.relation.select.join.manytomany.dao.UserDao;
import com.mybatisgx.relation.select.join.manytomany.dao.UserRoleDao;
import com.mybatisgx.relation.select.join.manytomany.entity.Role;
...
public class RoleDaoTest {
    ...
    public static void beforeClass() {
        SqlSession sqlSession = DaoTestUtils.getSqlSession(
                new String[]{"com.mybatisgx.relation.select.join.manytomany.entity"},
                new String[]{"com.mybatisgx.relation.select.join.manytomany.dao"}
        );
