package com.mybatisgx.relation.select.join.onetomany.test;

import com.mybatisgx.relation.select.join.onetomany.dao.OrgDao;
...
public class OrgDaoTest {
    ...
    public static void beforeClass() {
        SqlSession sqlSession = DaoTestUtils.getSqlSession(
                new String[]{"com.mybatisgx.relation.select.join.onetomany.entity"},
                new String[]{"com.mybatisgx.relation.select.join.onetomany.dao"}
        );
