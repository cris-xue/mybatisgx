package com.mybatisgx.relation.select.join.onetoone.test;

import com.github.swierkosz.fixture.generator.FixtureGenerator;
import com.mybatisgx.entity.MultiId;
import com.mybatisgx.relation.select.join.onetoone.dao.UserDao;
import com.mybatisgx.relation.select.join.onetoone.dao.UserDetailDao;
import com.mybatisgx.relation.select.join.onetoone.entity.User;
import com.mybatisgx.relation.select.join.onetoone.entity.UserDetail;
...
public class RelationSimpleUserDaoTest {
    ...
    public static void beforeClass() {
        SqlSession sqlSession = DaoTestUtils.getSqlSession(
                new String[]{"com.mybatisgx.relation.select.join.onetoone.entity"},
                new String[]{"com.mybatisgx.relation.select.join.onetoone.dao"}
        );
