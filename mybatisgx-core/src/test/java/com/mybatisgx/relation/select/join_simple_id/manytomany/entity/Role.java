...
@Entity
@Table(name = "jsi_mtm_role")
public class Role extends BaseEntity<Long> {
    private String code; private String name;
    @LogicDelete private Integer status;
    @Version private Integer version;
    @ManyToMany(fetch = FetchType.LAZY) @JoinTable(name = "jsi_mtm_user_role", joinColumns = @JoinColumn(name = "role_id"), inverseJoinColumns = @JoinColumn(name = "user_id")) @Fetch(FetchMode.JOIN) private List<User> userList;
