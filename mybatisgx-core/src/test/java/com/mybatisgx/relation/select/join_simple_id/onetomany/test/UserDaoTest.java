package com.mybatisgx.relation.select.join_simple_id.onetomany.test;

import com.github.swierkosz.fixture.generator.FixtureGenerator;
import com.mybatisgx.relation.select.join_simple_id.onetomany.dao.DeptDao;
import com.mybatisgx.relation.select.join_simple_id.onetomany.dao.OrgDao;
import com.mybatisgx.relation.select.join_simple_id.onetomany.dao.TeamDao;
import com.mybatisgx.relation.select.join_simple_id.onetomany.dao.UserDao;
...
import com.mybatisgx.relation.select.join_simple_id.onetomany.entity.User;
...
public class UserDaoTest {
    ...
    public static void beforeClass() {
        SqlSession sqlSession = DaoTestUtils.getSqlSession(
                new String[]{"com.mybatisgx.relation.select.join_simple_id.onetomany.entity"},
                new String[]{"com.mybatisgx.relation.select.join_simple_id.onetomany.dao"}
        );
    ...
    public void testFindById() {
        User dbUser = userDao.findById(777414L);
