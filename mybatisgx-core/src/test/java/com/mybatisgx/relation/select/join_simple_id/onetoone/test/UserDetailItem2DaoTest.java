package com.mybatisgx.relation.select.join_simple_id.onetoone.test;

import com.github.swierkosz.fixture.generator.FixtureGenerator;
import com.mybatisgx.relation.select.join_simple_id.onetoone.dao.UserDao;
import com.mybatisgx.relation.select.join_simple_id.onetoone.dao.UserDetailDao;
import com.mybatisgx.relation.select.join_simple_id.onetoone.dao.UserDetailItem1Dao;
import com.mybatisgx.relation.select.join_simple_id.onetoone.dao.UserDetailItem2Dao;
import com.mybatisgx.relation.select.join_simple_id.onetoone.entity.User;
import com.mybatisgx.relation.select.join_simple_id.onetoone.entity.UserDetail;
import com.mybatisgx.relation.select.join_simple_id.onetoone.entity.UserDetailItem1;
import com.mybatisgx.relation.select.join_simple_id.onetoone.entity.UserDetailItem2;
...
public class UserDetailItem2DaoTest {
    ...
    private static Long firstUserDetailItem2Id;

    @BeforeClass
    public static void beforeClass() {
        SqlSession sqlSession = DaoTestUtils.getSqlSession(
                new String[]{"com.mybatisgx.relation.select.join_simple_id.onetoone.entity"},
                new String[]{"com.mybatisgx.relation.select.join_simple_id.onetoone.dao"}
        );
        ...
        firstUserDetailItem2Id = userDetailItem2List.get(0).getId();
    }
    ...
    public void testFindById() {
        UserDetailItem2 dbUserDetailItem2 = userDetailItem2Dao.findById(firstUserDetailItem2Id);
