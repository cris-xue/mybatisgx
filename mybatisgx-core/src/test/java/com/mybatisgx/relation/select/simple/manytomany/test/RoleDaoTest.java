package com.mybatisgx.relation.select.simple.manytomany.test;

import com.github.swierkosz.fixture.generator.FixtureGenerator;
import com.mybatisgx.relation.select.simple.manytomany.dao.RoleDao;
import com.mybatisgx.relation.select.simple.manytomany.dao.UserDao;
import com.mybatisgx.relation.select.simple.manytomany.dao.UserRoleDao;
...
import com.mybatisgx.relation.select.simple.manytomany.entity.UserRole;
...
public class RoleDaoTest {
    ...
    public static void beforeClass() {
        SqlSession sqlSession = DaoTestUtils.getSqlSession(
                new String[]{"com.mybatisgx.relation.select.simple.manytomany.entity"},
                new String[]{"com.mybatisgx.relation.select.simple.manytomany.dao"}
        );
