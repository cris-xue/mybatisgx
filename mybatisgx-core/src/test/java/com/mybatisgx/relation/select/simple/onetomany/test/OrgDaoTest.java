package com.mybatisgx.relation.select.simple.onetomany.test;

import com.mybatisgx.relation.select.simple.onetomany.dao.OrgDao;
...
public class OrgDaoTest {
    ...
    public static void beforeClass() {
        SqlSession sqlSession = DaoTestUtils.getSqlSession(
                new String[]{"com.mybatisgx.relation.select.simple.onetomany.entity"},
                new String[]{"com.mybatisgx.relation.select.simple.onetomany.dao"}
        );
