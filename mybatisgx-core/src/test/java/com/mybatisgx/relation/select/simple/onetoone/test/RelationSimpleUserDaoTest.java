package com.mybatisgx.relation.select.simple.onetoone.test;

import com.github.swierkosz.fixture.generator.FixtureGenerator;
import com.mybatisgx.entity.MultiId;
import com.mybatisgx.relation.select.simple.onetoone.dao.UserDao;
import com.mybatisgx.relation.select.simple.onetoone.dao.UserDetailDao;
...
public class RelationSimpleUserDaoTest {
    ...
    public static void beforeClass() {
        SqlSession sqlSession = DaoTestUtils.getSqlSession(
                new String[]{"com.mybatisgx.relation.select.simple.onetoone.entity"},
                new String[]{"com.mybatisgx.relation.select.simple.onetoone.dao"}
        );
