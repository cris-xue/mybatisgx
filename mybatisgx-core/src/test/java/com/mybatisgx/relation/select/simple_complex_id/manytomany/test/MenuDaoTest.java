...
public class MenuDaoTest {
    ...
    private static long joinId = 700000;
    ...
    private static void buildData() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                ...
                multiId.setId1(733111L);
                multiId.setId2(733111L);
                user.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(733112L);
                multiId.setId2(733112L);
                role.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(733113L);
                multiId.setId2(733113L);
                menu.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(733114L);
                multiId.setId2(733114L);
