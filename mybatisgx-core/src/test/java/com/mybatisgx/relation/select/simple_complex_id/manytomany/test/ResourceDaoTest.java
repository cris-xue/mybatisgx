    ...
    private static void buildData() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                ...
                multiId.setId1(744111L);
                multiId.setId2(744111L);
                user.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(744112L);
                multiId.setId2(744112L);
                role.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(744113L);
                multiId.setId2(744113L);
                menu.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(744114L);
                multiId.setId2(744114L);
