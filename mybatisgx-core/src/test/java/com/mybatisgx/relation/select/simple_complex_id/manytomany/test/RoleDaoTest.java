    ...
    private static void buildData() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                ...
                multiId.setId1(722111L);
                multiId.setId2(722111L);
                user.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(722112L);
                multiId.setId2(722112L);
                role.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(722113L);
                multiId.setId2(722113L);
                menu.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(722114L);
                multiId.setId2(722114L);
