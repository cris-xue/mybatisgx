...
import com.mybatisgx.relation.select.simple_complex_id.manytomany.dao.MenuDao;
import com.mybatisgx.relation.select.simple_complex_id.manytomany.dao.MenuResourceJoinDao;
import com.mybatisgx.relation.select.simple_complex_id.manytomany.dao.ResourceDao;
import com.mybatisgx.relation.select.simple_complex_id.manytomany.dao.RoleDao;
import com.mybatisgx.relation.select.simple_complex_id.manytomany.dao.RoleMenuJoinDao;
import com.mybatisgx.relation.select.simple_complex_id.manytomany.dao.UserDao;
import com.mybatisgx.relation.select.simple_complex_id.manytomany.dao.UserRoleJoinDao;
import com.mybatisgx.relation.select.simple_complex_id.manytomany.entity.Menu;
import com.mybatisgx.relation.select.simple_complex_id.manytomany.entity.MenuResourceJoin;
import com.mybatisgx.relation.select.simple_complex_id.manytomany.entity.Resource;
import com.mybatisgx.relation.select.simple_complex_id.manytomany.entity.Role;
import com.mybatisgx.relation.select.simple_complex_id.manytomany.entity.RoleMenuJoin;
import com.mybatisgx.relation.select.simple_complex_id.manytomany.entity.User;
import com.mybatisgx.relation.select.simple_complex_id.manytomany.entity.UserRoleJoin;
...
public class UserDaoTest {
    ...
    private static long joinId = 500000;
    ...
    public static void beforeClass() {
        SqlSession sqlSession = DaoTestUtils.getSqlSession(
                new String[]{"com.mybatisgx.relation.select.simple_complex_id.manytomany.entity"},
                new String[]{"com.mybatisgx.relation.select.simple_complex_id.manytomany.dao"}
        );
    ...
    private static void buildData() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                ...
                multiId.setId1(711111L);
                multiId.setId2(711111L);
                user.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(711112L);
                multiId.setId2(711112L);
                role.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(711113L);
                multiId.setId2(711113L);
                menu.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(711114L);
                multiId.setId2(711114L);
