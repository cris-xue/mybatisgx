    ...
    private static void buildData() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                ...
                multiId.setId1(622111L);
                multiId.setId2(622111L);
                org.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(622112L);
                multiId.setId2(622112L);
                dept.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(622113L);
                multiId.setId2(622113L);
                team.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(622114L);
                multiId.setId2(622114L);
