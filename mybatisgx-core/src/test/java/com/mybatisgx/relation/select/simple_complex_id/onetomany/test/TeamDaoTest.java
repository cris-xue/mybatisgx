    ...
    private static void buildData() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                ...
                multiId.setId1(633111L);
                multiId.setId2(633111L);
                org.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(633112L);
                multiId.setId2(633112L);
                dept.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(633113L);
                multiId.setId2(633113L);
                team.setMultiId(multiId);
                multiId = new MultiId();
                multiId.setId1(633114L);
                multiId.setId2(633114L);
