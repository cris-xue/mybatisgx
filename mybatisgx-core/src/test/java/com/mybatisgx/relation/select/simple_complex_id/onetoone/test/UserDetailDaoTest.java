    ...
    private static void buildData() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                ...
                multiId.setId1(522111L);
                multiId.setId2(522111L);
            ...
            if (i == 0) {
                MultiId<Long> multiId = new MultiId();
                multiId.setId1(522112L);
                multiId.setId2(522112L);
            ...
            if (i == 0) {
                MultiId<Long> multiId = new MultiId();
                multiId.setId1(522113L);
                multiId.setId2(522113L);
            ...
            if (i == 0) {
                MultiId<Long> multiId = new MultiId();
                multiId.setId1(522114L);
                multiId.setId2(522114L);
