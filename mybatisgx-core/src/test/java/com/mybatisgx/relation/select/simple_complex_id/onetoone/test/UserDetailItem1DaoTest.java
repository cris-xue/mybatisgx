...
public class UserDetailItem1DaoTest {
    ...
    private static void buildData() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                ...
                multiId.setId1(533111L);
                multiId.setId2(533111L);
            ...
            if (i == 0) {
                MultiId<Long> multiId = new MultiId();
                multiId.setId1(533112L);
                multiId.setId2(533112L);
            ...
            if (i == 0) {
                MultiId<Long> multiId = new MultiId();
                multiId.setId1(533113L);
                multiId.setId2(533113L);
            ...
            if (i == 0) {
                MultiId<Long> multiId = new MultiId();
                multiId.setId1(533114L);
                multiId.setId2(533114L);
    ...
    public void testFindById() {
        ...
        multiId.setId1(533113L);
        multiId.setId2(533113L);
        UserDetailItem1 dbUserDetailItem1 = userDetailItem1Dao.findById(multiId);
