    ...
    private static void buildData() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                ...
                multiId.setId1(544111L);
                multiId.setId2(544111L);
            ...
            if (i == 0) {
                MultiId<Long> multiId = new MultiId();
                multiId.setId1(544112L);
                multiId.setId2(544112L);
            ...
            if (i == 0) {
                MultiId<Long> multiId = new MultiId();
                multiId.setId1(544113L);
                multiId.setId2(544113L);
            ...
            if (i == 0) {
                MultiId<Long> multiId = new MultiId();
                multiId.setId1(544114L);
                multiId.setId2(544114L);
