create table if not exists join_oto_user_complex
(
    id1            bigint      not null,
    id2            bigint      not null,
...
create table if not exists join_oto_user_detail_complex
(
    id1            bigint      not null,
    id2            bigint      not null,
...
create table if not exists join_oto_user_detail_item1_complex
(
    id1             bigint      not null,
    id2             bigint      not null,
    code            varchar(64) not null comment '',
...
create table if not exists join_oto_user_detail_item2_complex
(
    id1                   bigint      not null,
    id2                   bigint      not null,
    code                  varchar(64) not null comment '',
...
create table if not exists join_oto_user_simple
(
    id             bigint      not null,
    code           varchar(64) null comment '',
...
create table if not exists join_oto_user_detail_simple
(
    id             bigint      not null,
    code           varchar(64) not null comment '',
...
create table if not exists join_oto_user_detail_item1_simple
(
    id              bigint      not null,
    code            varchar(64) not null comment '',
...
create table if not exists join_oto_user_detail_item2_simple
(
    id                    bigint      not null,
    code                  varchar(64) not null comment '',
