...
create table if not exists join_otm_org_simple
(
    id             bigint      not null,
    code           varchar(64) null comment '',
...
create table if not exists join_otm_dept_simple
(
    id             bigint      not null,
    code           varchar(64) not null comment '',
...
create table if not exists join_otm_team_simple
(
    id             bigint      not null,
    code           varchar(64) not null comment '',
...
create table if not exists join_otm_user_simple
(
    id             bigint      not null,
    code           varchar(64) not null comment '',
