...
create table if not exists batch_otm_dept_complex
(
    id1            bigint      not null,
    id2            bigint      not null,
...
create table if not exists batch_otm_team_complex
(
    id1            bigint      not null,
    id2            bigint      not null,
    code           varchar(64) not null comment '',
...
create table if not exists batch_otm_org_simple
(
    id             bigint      not null,
    code           varchar(64) null comment '',
...
create table if not exists batch_otm_dept_simple
(
    id             bigint      not null,
    code           varchar(64) not null comment '',
...
create table if not exists batch_otm_team_simple
(
    id             bigint      not null,
    code           varchar(64) not null comment '',
...
create table if not exists batch_otm_user_simple
(
    id             bigint      not null,
    code           varchar(64) not null comment '',
