create table if not exists batch_mtm_user_complex
(
    id1            bigint      not null,
    id2            bigint      not null,
...
create table if not exists batch_mtm_role_complex
(
    id1            bigint      not null,
    id2            bigint      not null,
...
create table if not exists batch_mtm_menu_complex
(
    id1            bigint      not null,
    id2            bigint      not null,
    code           varchar(64) not null comment '',
...
create table if not exists batch_mtm_resource_complex
(
    id1            bigint      not null,
    id2            bigint      not null,
    code           varchar(64) not null comment '',
...
create table if not exists batch_mtm_user_simple
(
    id             bigint      not null,
    code           varchar(64) null comment '',
...
create table if not exists batch_mtm_user_role_simple
(
    id      bigint not null,
...
create table if not exists batch_mtm_role_simple
(
    id             bigint      not null,
    code           varchar(64) not null comment '',
    name           varchar(64) null comment '',
...
create table if not exists batch_mtm_role_menu_simple
(
    id      bigint not null,
    role_id bigint not null comment '',
...
create table if not exists batch_mtm_menu_simple
(
    id             bigint      not null,
    code           varchar(64) not null comment '',
    name           varchar(64) null comment '',
...
create table if not exists batch_mtm_menu_resource_simple
(
    id          bigint not null,
    menu_id     bigint not null comment '',
...
create table if not exists batch_mtm_resource_simple
(
    id             bigint      not null,
    code           varchar(64) not null comment '',
    name           varchar(64) null comment '',
