...
public class MybatisxSqlSessionTemplate extends SqlSessionTemplate {
    ...
    public MybatisxSqlSessionTemplate(SqlSessionFactory sqlSessionFactory, ExecutorType executorType,
        ...
        this.sqlSessionProxy = (SqlSession) newProxyInstance(SqlSessionFactory.class.getClassLoader(),
                new Class[]{SqlSession.class}, new MybatisxSqlSessionTemplate.SqlSessionInterceptor());
    }
    ...
    private class SqlSessionInterceptor implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            MethodInfo methodInfo = MethodInfoContextHolder.get(statement);
            ExecutorType executorType = methodInfo.getBatch() ? ExecutorType.BATCH : MybatisxSqlSessionTemplate.this.executorType;
            SqlSession sqlSession = getSqlSession(MybatisxSqlSessionTemplate.this.sqlSessionFactory, executorType, MybatisxSqlSessionTemplate.this.exceptionTranslator);
            try {
                Object result = method.invoke(sqlSession, args);
                if (!isSqlSessionTransactional(sqlSession, MybatisxSqlSessionTemplate.this.sqlSessionFactory)) {
                ...
                if (MybatisxSqlSessionTemplate.this.exceptionTranslator != null && unwrapped instanceof PersistenceException) {
                    // release the connection to avoid a deadlock if the translator is no loaded. See issue #22
                    closeSqlSession(sqlSession, MybatisxSqlSessionTemplate.this.sqlSessionFactory);
                    sqlSession = null;
                    Throwable translated = MybatisxSqlSessionTemplate.this.exceptionTranslator
