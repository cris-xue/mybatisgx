...
import com.lc.mybatisx.reflection.MybatisxParamNameResolver;
 ...
 * @date ：2020/8/7 13:45
 */
public class MybatisxMapperMethod {
    ...
    public MybatisxMapperMethod(Class<?> mapperInterface, Method method, Configuration config) {
        this.command = new SqlCommand(config, mapperInterface, method);
        if (command.type == SqlCommandType.UPDATE || command.type == SqlCommandType.DELETE) {
            getVersion(mapperInterface);
        }

        this.method = new MethodSignature(config, mapperInterface, method, version);
        this.mapperInterface = mapperInterface;
        this.originalMethod = method;
    }

    private void getVersion(Class<?> mapperInterface) {
    ...
    public static class MethodSignature {
        ...
        private final MybatisxParamNameResolver paramNameResolver;

        public MethodSignature(Configuration configuration, Class<?> mapperInterface, Method method, String version) {
            ...
            this.paramNameResolver = new MybatisxParamNameResolver(configuration, method, version);
        }
