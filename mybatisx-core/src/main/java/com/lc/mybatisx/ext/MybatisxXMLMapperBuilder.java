...
/**
 * create by: 薛承城
 * description: CustomXMLMapperBuilder完全使用了Mybatis源码。
 * 由于需要动态增加Dom节点。增加了getCurrentNodeData方法，具体描述查看该方法。
 * configurationElement是mybatis原有的方法，在最后对源码进行了修改
 * create time: 2019/5/9 17:54
 */
public class MybatisxXMLMapperBuilder extends BaseBuilder {
    ...
    public MybatisxXMLMapperBuilder(InputStream inputStream, Configuration configuration, String resource, Map<String, XNode> sqlFragments) {
        this(new XPathParser(inputStream, true, configuration.getVariables(), new XMLMapperEntityResolver()),
                configuration, resource, sqlFragments);
    }

    private MybatisxXMLMapperBuilder(XPathParser parser, Configuration configuration, String resource, Map<String, XNode> sqlFragments) {
        super(configuration);
