 ...
 * @date ：2020/7/5 12:56
 */
public class InsertMapperHandlerFilter implements MapperHandlerFilter {

    private static final Logger logger = LoggerFactory.getLogger(InsertMapperHandlerFilter.class);
