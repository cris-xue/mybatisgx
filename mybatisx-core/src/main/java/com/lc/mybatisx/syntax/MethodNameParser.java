...
public class MethodNameParser extends Parser {
	...
	public static final int
		...
		RULE_condition_item_clause = 15, RULE_logic_op_clause = 16, RULE_field_condition_op_clause = 17, 
		RULE_comparison_op_clause = 18, RULE_group_clause = 19, RULE_group_op_clause = 20, 
		RULE_order_clause = 21, RULE_order_op_clause = 22, RULE_order_op_direction_clause = 23, 
		RULE_aggregate_function_clause = 24, RULE_field_clause = 25;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"logic_op_clause", "field_condition_op_clause", "comparison_op_clause", 
	...
	public final Field_condition_op_clauseContext field_condition_op_clause() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_field_condition_op_clause);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Comparison_op_clauseContext comparison_op_clause() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_comparison_op_clause);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(123);
	...
	public final Group_clauseContext group_clause() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_group_clause);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Group_op_clauseContext group_op_clause() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_group_op_clause);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(130);
	...
	public final Order_clauseContext order_clause() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_order_clause);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Order_op_clauseContext order_op_clause() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_order_op_clause);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(144);
	...
	public final Order_op_direction_clauseContext order_op_direction_clause() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_order_op_direction_clause);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(146);
	...
	public final Aggregate_function_clauseContext aggregate_function_clause() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_aggregate_function_clause);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(148);
	...
	public final Field_clauseContext field_clause() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_field_clause);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
